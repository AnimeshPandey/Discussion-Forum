...
<html lang="en" class="no-js">
    <head>
        ...
        <title>Edit Post | Alumni Portal IIITDMJ</title>
    </head>
    ...
    <body>
        ...
        <div class="container">
            ...
            <form class="col s12" method="post" action="/admin/edit_post">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">

                <div class="input-field col s12 m6 offset-m3">
                    <input type="hidden" name="id" id="id" value="{{$post->id}}">
                    <input type="hidden" name="body" id="body">
                    <input id="heading" name="heading" type="text" value="{{$post->heading}}" required />
...
//                
                ...
                //console.log(typeof($("#summernote").code(markupstr)));
                $('#summernote').code('{!!html_entity_decode($post->body)!!}');
            });
            
            var markupstr = '{!!html_entity_decode($post->body)!!}';
                var edit = document.getElementsByClassName("note-editable");
                edit[0].innerHTML = "Alumni Portal";
