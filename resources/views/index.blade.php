...
<html lang="en" class="no-js">
    <head>
        ...
        <title>Discussion Board | Alumni Portal IIITDMJ</title>
    </head>
            ...
            <header class="row">
                <nav class="col s12">
                    <ul class="col s12">
                        ...
                        <div class="logo-container col s4 m2"><a href="#"><div class="logo col s12"><img src="img/slogo.png" style="padding-top: 10px; margin-bottom: -10px;"></div></a></div>
                ...
                <h2 class="col s12 m8 offset-m2">Welcome to the Discussion Portal</h2>
                <h1 class="col s12 m8 offset-m2">Alumni Portal IIITDMJ</h1>
