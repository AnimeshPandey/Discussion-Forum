...
<html lang="en" class="no-js">
    <head>
        ...
        <title>Blog | Alumni Portal IIITDMJ</title>
    </head>
    ...
    <body>
        <div class="row" style="background-color:rgba(255,255,255,0.4);margin-bottom:-30px;padding-bottom:30px;">
                    ...
                    <div class="article-container row">
                        ...
                        <script> /** * RECOMMENDED CONFIGURATION VARIABLES: EDIT AND UNCOMMENT THE SECTION BELOW TO INSERT DYNAMIC VALUES FROM YOUR PLATFORM OR CMS. * LEARN WHY DEFINING THESE VARIABLES IS IMPORTANT: https://disqus.com/admin/universalcode/#configuration-variables */ 
                         var disqus_config = function () { 
                             ...
                             s.src = 'https://alumniportaliiitdmj.disqus.com/embed.js'; 
            ...
            <div class="mask post col s12 m3 offset-m9">
                <header class="row col s12">
                    <nav class="col s12">
                        <ul class="col s12">
                            <div class="logo-container col s10 offset-s1 m12"><a href="/"><div class="logo col s6 offset-s3 m12"><img src="/img/slogo.png"></div></a></div>
                            <h1 class="col s12">Alumni Portal IIITDMJ</h1>
        ...
        <script id="dsq-count-scr" src="//alumniportaliiitdmj.disqus.com/count.js" async></script>
        <script>
            /*Smooth Scroll*/
			$(function() {
